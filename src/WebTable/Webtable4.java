	...
	public static void main(String[] args) {
			...
			WebDriver driver = new ChromeDriver();
					...
					if(Lname.equals("Bach"))
						...
						String Due=driver.findElement(By.xpath("//table[@id='table1']/tbody/tr["+r+"]/td[4]")).getText();
						
						String Website=driver.findElement(By.xpath("//table[@id='table1']/tbody/tr["+r+"]/td[5]")).getText();
						
						String Action=driver.findElement(By.xpath("//table[@id='table1']/tbody/tr["+r+"]/td[6]")).getText();
